...
{
    var x1 = RandomDouble(0d, 1d);
    var x2 = RandomDouble(0d, 1d);
...
/// <param name="miu">均值μ</param>
/// <param name="sigma">方差σ</param>
/// <param name="min">左边界</param>
/// <param name="max">右边界</param>
/// <returns>返回范围为[min, max]</returns>
public static double TruncatedNormalRandom(double miu, double sigma, double min, double max)
{
    double p = RandomDouble(double.Epsilon, 1d);
