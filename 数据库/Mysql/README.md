...
1. [系统变量](variable/system-variable/)
	1. [通用系统变量](variable/system-variable/general-variables.md)
	1. [InnoDb系统变量](variable/system-variable/innodb-variables.md)
...
1. [数据类型](datatype)
	1. [数值型数据类型](datatype/numeric-type.md)
		1. [整型数据类型](datatype/numeric-type.md#integer-type)
		1. [小数数据类型](datatype/numeric-type.md#decimal-type)
		1. [浮点数据类型](datatype/numeric-type.md#float-type)
		1. [位数据类型](datatype/numeric-type.md#bit-type)
...
1. 系统库
	1. INFORMATION_SCHEMA
		...
		1. InnoDB
			1. [INNODB_LOCKS](meta/innodb_locks-table.md) 锁
		1. 字符集和校对
