...
Base为100时，根据Mod的值来决定寄存器。

| Mod | SIB | 寻址方式 |
|---|---|---|
| 00 | Scale * Index + disp32 | Scale * Index + disp32 |
| 01 | Scale * Index + [EBP] | Scale * Index + disp8 + [EBP] |
| 10 | Scale * Index + [EBP] | Scale * Index + disp32 + [EBP] |